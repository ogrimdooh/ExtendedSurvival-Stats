...
namespace ExtendedSurvival.Stats
{
    ...
    public static class QuimicalConstants
    {
            ...
            RecipesDefinition = new List<SimpleRecipeDefinition>()
            {
                new SimpleRecipeDefinition()
                {
                    ...
                    Ingredients = new SimpleRecipeDefinition.RecipeItem[]
                    {
                        ...
                        new SimpleRecipeDefinition.RecipeItem()
                        {
                            Id = FoodConstants.AMANITAMUSCARIA_ID,
                            Ammount = 15f
                        }
                    }
                }
        ...
        public static void RegisterShopItens()
        {
            ...
            ExtendedSurvivalCoreAPI.AddItemToShop(new StationShopItemInfo()
            {
                Id = SMALLALOEVERAEXTRACT_ID.DefinitionId,
                Rarity = ItemRarity.Normal,
                CanBuy = true,
                CanSell = true,
                CanOrder = true,
            ...
            ExtendedSurvivalCoreAPI.AddItemToShop(new StationShopItemInfo()
            {
                Id = ALOEVERAEXTRACT_ID.DefinitionId,
                Rarity = ItemRarity.Normal,
                CanBuy = true,
                CanSell = true,
                CanOrder = true,
            ...
            ExtendedSurvivalCoreAPI.AddItemToShop(new StationShopItemInfo()
            {
                Id = ARNICAEXTRACT_ID.DefinitionId,
                Rarity = ItemRarity.Normal,
                CanBuy = true,
                CanSell = true,
                CanOrder = true,
            ...
            ExtendedSurvivalCoreAPI.AddItemToShop(new StationShopItemInfo()
            {
                Id = MINTEXTRACT_ID.DefinitionId,
                Rarity = ItemRarity.Normal,
                CanBuy = true,
                CanSell = true,
                CanOrder = true,
            ...
            ExtendedSurvivalCoreAPI.AddItemToShop(new StationShopItemInfo()
            {
                Id = CHAMOMILEEXTRACT_ID.DefinitionId,
                Rarity = ItemRarity.Normal,
                CanBuy = true,
                CanSell = true,
                CanOrder = true,
